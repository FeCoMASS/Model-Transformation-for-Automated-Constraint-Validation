 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.xtext.montiarcandcore.montiArcAndCore.impl.AutomatonImpl#isSync <em>Sync</em>}</li>
 *   <li>{@link org.palladiosimulator.xtext.montiarcandcore.montiArcAndCore.impl.AutomatonImpl#isName <em>Name</em>}</li>
 *   <li>{@link org.palladiosimulator.xtext.montiarcandcore.montiArcAndCore.impl.AutomatonImpl#getStates <em>States</em>}</li>
 *   <li>{@link org.palladiosimulator.xtext.montiarcandcore.montiArcAndCore.impl.AutomatonImpl#getTransitions <em>Transitions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AutomatonImpl extends ArcElementImpl implements Automaton
{
  ...
  {
    return MontiArcAndCorePackage.Literals.AUTOMATON;
  }
  ...
  public void setSync(boolean newSync)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MontiArcAndCorePackage.AUTOMATON__SYNC, oldSync, sync));
  }
  ...
  public void setName(boolean newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MontiArcAndCorePackage.AUTOMATON__NAME, oldName, name));
  }
  ...
  public EList<State> getStates()
  {
    if (states == null)
    {
      states = new EObjectContainmentEList<State>(State.class, this, MontiArcAndCorePackage.AUTOMATON__STATES);
    }
    return states;
  }
  ...
  public EList<Transition> getTransitions()
  {
    if (transitions == null)
    {
      transitions = new EObjectContainmentEList<Transition>(Transition.class, this, MontiArcAndCorePackage.AUTOMATON__TRANSITIONS);
    }
    return transitions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MontiArcAndCorePackage.AUTOMATON__STATES:
        return ((InternalEList<?>)getStates()).basicRemove(otherEnd, msgs);
      case MontiArcAndCorePackage.AUTOMATON__TRANSITIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MontiArcAndCorePackage.AUTOMATON__SYNC:
        return isSync();
      case MontiArcAndCorePackage.AUTOMATON__NAME:
        return isName();
      case MontiArcAndCorePackage.AUTOMATON__STATES:
        return getStates();
      case MontiArcAndCorePackage.AUTOMATON__TRANSITIONS:
