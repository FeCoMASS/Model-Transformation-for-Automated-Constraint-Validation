 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.xtext.montiarcandcore.montiArcAndCore.impl.SCStateImpl#getAnte <em>Ante</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SCStateImpl extends StateImpl implements SCState
{
  ...
  {
    return MontiArcAndCorePackage.Literals.SC_STATE;
  }
  ...
  public NotificationChain basicSetAnte(SCSAnte newAnte, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MontiArcAndCorePackage.SC_STATE__ANTE, oldAnte, newAnte);
  ...
  public void setAnte(SCSAnte newAnte)
  {
    if (newAnte != ante)
    {
      ...
      if (ante != null)
        msgs = ((InternalEObject)ante).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MontiArcAndCorePackage.SC_STATE__ANTE, null, msgs);
      if (newAnte != null)
        msgs = ((InternalEObject)newAnte).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MontiArcAndCorePackage.SC_STATE__ANTE, null, msgs);
      msgs = basicSetAnte(newAnte, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MontiArcAndCorePackage.SC_STATE__ANTE, newAnte, newAnte));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MontiArcAndCorePackage.SC_STATE__ANTE:
