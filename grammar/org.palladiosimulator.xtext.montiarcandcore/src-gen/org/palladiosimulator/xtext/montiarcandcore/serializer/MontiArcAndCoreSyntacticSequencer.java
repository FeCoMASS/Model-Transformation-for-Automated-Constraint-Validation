...
public class MontiArcAndCoreSyntacticSequencer extends AbstractSyntacticSequencer {

	protected MontiArcAndCoreGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (MontiArcAndCoreGrammarAccess) access;
	}
